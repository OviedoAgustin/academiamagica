...
UN UMPALUMPA POR CADA PROYECTO

ASIGNAMOS UN UMPALUMPA SIEMPRE Y CUANDO TENGAMOS UNO DISPONIBLE

ALMACENAR ALGUNAS PARTES DE SU PRODUCCION DE CHOCOLATE - ESTIMADO DE 5 FEATURES - SOLO UN UMPALUMPA

APP SIMIL A FACEBOOK - PERMITE ENCONTRAR TRABAJO - base de datos grande - twitter integrado - plataforma de pago y cobro - filtro para las fotos - geocities - 20 features - un umpaluma (puede haber mas) - cada vez que se resuelve una feature se agrega el doble de las que se resolvieron

la verdu necesita software para su balanza - no featres - se estima que tardara 10 dias para terminarse 